...
> reliably with `resources = TRUE`. The v2 migration also added the
> inline metadata columns and server-side filters described in the note
> to the first “Discovery improvement 1” section above.
