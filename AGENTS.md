...
doc are historical, not normative. The README and the vignette
`vignettes/datagouv.qmd` document usage for end users.

## Public API (8 exports)

- `dg_list_datasets(q = NULL, n = 1000, format = catalog_formats(), schema_only = FALSE, organization = NULL, geozone = NULL, access_type = NULL, license = NULL, tag = NULL, granularity = NULL, last_update = NULL, producer_type = NULL, resources = FALSE)`
  ...
  **client-side** (v2 has no “declares any schema” boolean); the filter
  args (`organization` \[24-hex id\], `geozone`, `access_type`,
  `license`, `tag`, `granularity`, `last_update`, `producer_type`) are
  forwarded as server-side filters. **Resource fidelity is opt-in**:
  because v2 search does NOT inline resources, `n_resources`, `formats`,
